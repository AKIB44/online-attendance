...
<table width="900" border="1" align="center">
      <tr>
        <td bordercolor="#330033" bgcolor="#FFF5EE"><marquee><h1 align="center"><strong><span class="style1"> **** Online Attendance ****</span></strong></h1></marquee></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <form action="" method="post">
          <table width="606" border="2" align="center" bordercolor="#9966FF" bgcolor="#C7B6B1">
          	<tr><td colspan="3" align="center"><h3>Search Enrollment No Wise Records Here</h3></td></tr>
            <tr>
		...
		if(isset($_POST["btnsubmit"]))
		{
			...
			while($rec = mysqli_fetch_array($result))
			{
				...
				<tr>
				  <td width="160" bgcolor="#9999CC"><span class="style2">Enrollment No</span></td>
		...
		else
		{
			...
			while($rec = mysqli_fetch_array($result))
			{
				echo '<tr><td colspan="1"><table width="75%" border="1" align="center" bordercolor="#9966FF" bgcolor="#C7B6B1">
				<tr>
				  <td width="160" bgcolor="#9999CC"><span class="style2">Enrollment No</span></td>
				  <td width="160" bgcolor="#9999CC"><span class="style2">Name</span></td>';
				  $query1 = "select * from `attendance` where `member_id` = ".$rec["member_id"]." order by date";
